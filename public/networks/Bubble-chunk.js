"use strict";
(self["webpackChunkIDVC"] = self["webpackChunkIDVC"] || []).push([[373],{
...
var BubbleModule = /*#__PURE__*/ function() {
    "use strict";
    function BubbleModule(worker) {
        _class_call_check(this, BubbleModule);
        _define_property(this, "worker", void 0);
        this.worker = worker;
    }
    _create_class(BubbleModule, [
        {
            key: "process",
            value: function process(data) {
                ...
                return new Promise(function(resolve) {
                    ...
                    _this.worker.onmessage = function(param) {
                        var segments = param.data.segments;
                        resolve(segments);
                    };
                });
            }
...
;// CONCATENATED MODULE: ./src/loader/loaderBubble.ts
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
    try {
        var info = gen[key](arg);
        var value = info.value;
...
/* harmony default export */ const loaderBubble = (/*#__PURE__*/_async_to_generator(function() {
    var worker, bubbleModule;
    return _ts_generator(this, function(_state) {
        switch(_state.label){
            case 0:
                return [
                    4,
                    (0,workers/* loadWorker */.o)("".concat(context/* default.chunkPublicPath */.Z.chunkPublicPath, "bubbleWorker.js"))
                ];
            case 1:
                worker = _state.sent();
                bubbleModule = new BubbleModule(worker);
                ModuleController/* default.setModule */.Z.setModule('module', 'bubble', bubbleModule);
                return [
                    2
                ];
        }
